            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-600">+63 (917) 300-2031</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-600">info@jkinnovative.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Unit 307 Casa Rafael, Quezon Ave, Quezon City, Philippines</p>
                </div>
              </div>
            </div>
          </div>
